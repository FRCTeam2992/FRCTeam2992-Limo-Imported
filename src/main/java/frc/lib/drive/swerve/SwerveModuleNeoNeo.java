...
public class SwerveModuleNeoNeo {
    ...
    public SwerveModuleNeoNeo(CANSparkMax driveMotor, CANSparkMax turnMotor, CANCoder encoderInput,
    ...
    public void setVelocityMeters(double speed) {
        ...
        driveMotor.getPIDController().setReference(RPM, CANSparkMax.ControlType.kVelocity);
    }
